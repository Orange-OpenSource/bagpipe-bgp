...
class TestRouteTableManager(TestCase, BaseTestBagPipeBGP):
    ...
    def testA2_SubscriptionsWithRouteToSynthetise(self):         
        ...
        self.assertEqual(mockBGPPeerWorker1.enqueue.call_count, 0, "Route should not be synthetised to its source")
        self.assertEqual(mockWorker3.enqueue.call_count, 0, "0 route should not be synthetised to Worker3")        
        self.assertEqual(mockBGPPeerWorker2.enqueue.call_count, 0, "Route should not be synthetised between BGPPeerWorkers")
        self.assertEqual(mockWorker1.enqueue.call_count, 2, "2 routes advertised should be synthetised to Worker1")    
        self._checkRouteEventsEnqueue(mockWorker1.enqueue.call_args_list,
                                      [routeEvent1.routeEntry, routeEvent2.routeEntry ], [])                    
        self.assertEqual(mockWorker2.enqueue.call_count, 1, "1 route advertise should be synthetised to Worker2")        
    ...
    def testA3_ReSubscription(self):         
        ...
        time.sleep(1)
        # check route entry synthetised
        self.assertEqual(mockWorker1.enqueue.call_count, 1, "1 route advertised should be synthetised to Worker1")    
        self._checkRouteEventsEnqueue(mockWorker1.enqueue.call_args_list,
                                      [routeEvent.routeEntry ], [])                    
        self.assertEqual(mockWorker2.enqueue.call_count, 1, "1 route advertised should be synthetised to Worker2")    
    ...
    def testB2_UnsubscriptionWithRouteToSynthetise(self):         
        ...
        self.assertEqual(mockWorker3.enqueue.call_count, 0, "0 route should not be synthetised to Worker3")        
        self.assertEqual(mockBGPPeerWorker2.enqueue.call_count, 0, "Route should not be synthetised between BGPPeerWorkers")
        self.assertEqual(mockWorker1.enqueue.call_count, 2, "2 routes should be synthetised to Worker1 : 2 advertise")      
        self._checkRouteEventsEnqueue(mockWorker1.enqueue.call_args_list,
                                      [routeEvent1.routeEntry, routeEvent2.routeEntry ], [])        
        self.assertEqual(mockWorker2.enqueue.call_count, 4, "4 routes should be synthetised to Worker2 : 2 advertise and 2 withdraw")        
        self._checkRouteEventsEnqueue(mockWorker2.enqueue.call_args_list,
                                      [routeEvent1.routeEntry, routeEvent2.routeEntry ],
    ...
    def testC3_routeAdvertiseByBGPPeerWithPropagation(self):
        ...
        self.assertEqual(mockWorker1.enqueue.call_count, 1, "1 route should be propagated to Worker1")
        self._checkRouteEventsEnqueue(mockWorker1.enqueue.call_args_list, [ routeEvent.routeEntry ], [])                      
        self.assertEqual(mockWorker2.enqueue.call_count, 0, "0 route should not be propagated to Worker2")        
        self.assertEqual(mockBGPPeerWorker1.enqueue.call_count, 0, "Route should not be propagated to its source")
        self.assertEqual(mockBGPPeerWorker2.enqueue.call_count, 0, "Route should not be propagated between BGPPeerWorkers")
    ...
    def testC4_routeWithdrawByPeerWorkerWithPropagation(self):
        ...
        time.sleep(1)
        # check routeEvent propagation
        self.assertEqual(mockWorker1.enqueue.call_count, 2, "2 routes should be propagated to Worker1")
        self._checkRouteEventsEnqueue(mockWorker1.enqueue.call_args_list, [ routeEventA.routeEntry ],
                                      [ routeEventW.routeEntry.nlri ])                      
        self.assertEqual(mockWorker2.enqueue.call_count, 2, "2 routes should be propagated to Worker2")  
        self._checkRouteEventsEnqueue(mockWorker2.enqueue.call_args_list, [ routeEventA.routeEntry ],
                                      [ routeEventW.routeEntry.nlri ])                      
        self.assertEqual(mockWorker3.enqueue.call_count, 0, "No route should be propagated to Worker3")
        self.assertEqual(mockBGPPeerWorker1.enqueue.call_count, 0, "Route should not be propagated to its source")
        self.assertEqual(mockBGPPeerWorker2.enqueue.call_count, 0, "Route should not be propagated between BGPPeerWorkers")
    ...
    def testC5_routeUpdateByBGPPeerWithWithdrawPropagation(self):
        ...
        self.assertEqual(mockBGPPeerWorker1.enqueue.call_count, 0, "Route should not be propagated to its source")
        self.assertEqual(mockWorker1.enqueue.call_count, 2, "2 routes should be advertised to Worker1")
        self._checkRouteEventsEnqueue(mockWorker1.enqueue.call_args_list,
                                      [routeEvent1.routeEntry, routeEvent2.routeEntry ], [])        
        self.assertEqual(mockWorker2.enqueue.call_count, 2, "2 routes should be advertised to Worker2")
        self._checkRouteEventsEnqueue(mockWorker2.enqueue.call_args_list,
                                      [routeEvent1.routeEntry, routeEvent2.routeEntry ], [])        
        self.assertEqual(mockWorker3.enqueue.call_count, 2, "2 routes should be advert/withdraw to Worker3")
    ...
    def testC6_routeReadvertised(self):
        ...
        # check route event propagation
        self.assertEqual(mockBGPPeerWorker1.enqueue.call_count, 0, "Route should not be propagated to its source")
        self.assertEqual(mockWorker1.enqueue.call_count, 1, "TO BE ENHANCED : only 1 route should be advertised to Worker1")
    ...
    def testC7_routeWithdrawNotRegistered(self):
        ...
        time.sleep(1)
        # check routeEvent propagation
        self.assertEqual(mockWorker1.enqueue.call_count, 1, "1 route1 should be propagated to Worker1")
        self._checkRouteEventsEnqueue(mockWorker1.enqueue.call_args_list, [ routeEventA.routeEntry ], [ ])                      
        self.assertEqual(mockBGPPeerWorker1.enqueue.call_count, 0, "Route should not be propagated to its source")
    ...
    def testD1_WorkerCleanup(self):         
        ...
        self.assertEqual(mockWorker1.enqueue.call_count, 2, "2 routes should be advert/withdraw to Worker1")
        self._checkRouteEventsEnqueue(mockWorker1.enqueue.call_args_list,
                                      [routeEvent1.routeEntry ], [routeEvent1.routeEntry.nlri])        
        self.assertEqual(mockWorker2.enqueue.call_count, 4, "4 routes should be advert/withdraw to Worker2")
        self._checkRouteEventsEnqueue(mockWorker2.enqueue.call_args_list,
                                      [routeEvent1.routeEntry, routeEvent2.routeEntry ],
                                      [routeEvent1.routeEntry.nlri, routeEvent2.routeEntry.nlri])     
